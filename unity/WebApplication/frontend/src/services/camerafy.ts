...
/** 25/05/2020 5:18:57 PM */
/* eslint-disable */

import { UUID } from '@/api/utils/utils';
		...
		return {
			User:
			{
				ClientRtcReady: () =>
				{
					...
					this.EventBus.send(OpCode);
					return new Promise((resolve, reject) => { this.PendingRequests.set(messageId, resolve); });
				},
